...
const Distinct = () => {
  ...
  return (
    <div className="w-[900px] mx-auto p-10 bg-white text-black font-sans  flex">
        {/* Header */}
        <div className="sidebar bg-purple-600 px-5 text-white">
            <div className='  py-2.5 flex flex-col justify-center items-center '>
                <div>
                    <h2 className='text-4xl font-bold'>ABAS THOMAS</h2>
                    <p className='text-[20px]  font-semibold mt-1.5'>Software Devloper</p>
                </div>
                <div className='w-30 h-30  bg-gray-300 rounded-full mt-3.5'><img src="#" alt="" /></div>
            </div>
                 <div className=' justify-self-start mt-[20px] text-white'>
                <div className='border-b-3 border-white py-2.5'><h1 className='uppercase text-[22px] '>Contact</h1></div>

                {user.map(({ input}) => (
                <div  className=" p-2 rounded-[8px] flex items-center ">
                ...
                <div className='border-b-3 border-white py-2.5'><h1 className='uppercase text-[22px] '>Skills</h1></div>
    ...
    <div className="normall px-6">
          <div className="professionalSumm">
            <div className='border-b-2   border-purple-700 py-2.5'><h1 className='font-semibold text-[22px] '>Professional Summary</h1></div>
        ...
        <div className="experience">
            ...
            <div className='border-b-2   border-purple-700 py-2.5'><h1 className='font-semibold text-[22px] '>Experience</h1></div>
        ...
        <div className="education mt-3">
             <div className='border-b-2   border-purple-700 py-2.5'><h1 className='font-bold text-[22px] '>Education</h1></div>
        ...
        <div className="references">
             <div className='border-b-2   border-purple-700 py-2.5 mt-3'><h1 className='font-bold text-[22px] '>References</h1></div>
